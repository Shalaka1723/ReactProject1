...
{/* OUR WORK */}
       <div className='text-white self-center'  >
        ...
        <div className='flex flex-row mt-20 '>
            <div className='bg-yellow-400 place-content-center p-10  w- flex flex-col gap-10  content-center'> 
            
            <div>
              <KeyboardDoubleArrowRightIcon className='float-left ' sx={{ fontSize: 60, color: 'white' }}/>
            
            
              <h1 className='font-bold'>Eco Friendly Construction
              </h1> 
              <p>
              ...
              Donec sollicitudin molestie malesuada. Praesent sapien massa, convallis a pellentesque nec, egestas non nisi. 
                  ...
                  <div className=' flex flex-col '> 
                      <div className='bg-gray-100 p-28 pb-32 '> 
                          ...
                          <h1 className=' font-bold text-4xl'>No Project Too Big Or Too Small</h1>
                      ...
                      <div className='flex flex-row p-6 place-content-between bg-black '> 
                            ...
                            <h1 className= 'font-bold text-4xl text-white self-center'>  Get Free Consultation 
                            </h1>  
                            <button className='border-yellow-400 border-4 m-5 p-4  text-yellow-400 font-bold '>  ONLINE ESTIMATE FORM
                            </button> 
                          </div>
        ...
        <img src={cclbg1} className=" h-[720px] w-full relative top-0 brightness-[0.25]  " />
          ...
          <h1 className=' p-16 text-center text-5xl font-bold'> Client Testimonials</h1>
          <hr className=' mt-6 mb-6 w-16 border-4 border-yellow-400 '></hr> 
            ...
            <div className=' pl-32 pr-32 flex flex-row gap-16 mt-4 '> 
                ...
                <div className='bg-white p-10 pl-16 pr-16 text-lg w-1/3 content-center justify-items-center justify-center justify-self-center'>
                    ...
                    <StarIcon sx={{ color: yellow[500] }} />
                    <StarIcon sx={{ color: yellow[500] }} />
                    <p className='mt-8 mb-8'>  “Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sapien, dignissim tristique tellus sed faucibus nullam.” 
                    </p>  
            ...
            <img src={Clients} className='content-center' width={1000} />
          </div>
